# HL7 EU Imaging Studies and Reports Implementation Guide R4.
...
This repo is not edited manually but based on the output of the build of the https://github.com/hl7-eu/imaging repo.

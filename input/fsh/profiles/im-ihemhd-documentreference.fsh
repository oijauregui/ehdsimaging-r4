...
* content 1..1
  * attachment 1..1
    ...
    * language 
    * creation 
* extension contains 	http://hl7.org/fhir/5.0/StructureDefinition/extension-DocumentReference.bodySite named bodySite  0..* and http://hl7.org/fhir/5.0/StructureDefinition/extension-DocumentReference.modality named modality 0..*

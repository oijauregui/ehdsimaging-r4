...
//R5Alias: $EuLocation             = http://hl7.eu/fhir/base-r5/StructureDefinition/location-eu
//R5Alias: $EuLocationUrl          = http://hl7.eu/fhir/base-r5/StructureDefinition/location-eu
...
Alias: $EuOrganizationUrl      = http://hl7.eu/fhir/base/StructureDefinition/organization-eu-core

Alias: $EuPatient              = http://hl7.eu/fhir/base/StructureDefinition/patient-eu-core
Alias: $EuPatientUrl           = http://hl7.eu/fhir/base/StructureDefinition/patient-eu-core
...
Alias: $EuPractitionerRoleUrl  = http://hl7.eu/fhir/base/StructureDefinition/practitionerRole-eu-core

Alias: $EuPractitioner         = http://hl7.eu/fhir/base/StructureDefinition/practitioner-eu-core
Alias: $EuPractitionerUrl      = http://hl7.eu/fhir/base/StructureDefinition/practitioner-eu-core
